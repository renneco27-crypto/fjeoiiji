...
### Community 2 - "app.js"
Cohesion: 0.10
Nodes (21): buildGameItem(), buildRefutationNarration(), cancelReview(), createAnalysisPool(), endReview(), initEngine(), jumpToLandmark(), pickMsg() (+13 more)
...
### Community 19 - "classifyMove"
Cohesion: 0.40
Nodes (5): classifyAndPushMove(), classifyMove(), detectBrilliantSacrifice(), getThresh(), toCp()
